...
class Stanford3DDatasetConverter:
    ...
    CLASSES = [
        'clutter', 'beam', 'board', 'bookcase', 'ceiling', 'chair', 'column',
...
def generate_splits(stanford_out_path):
    ...
    for i in range(1, 7):
        ...
        files = [
            os.path.relpath(full_path, stanford_out_path)
...
if __name__ == '__main__':
    Stanford3DDatasetConverter.convert_to_ply(STANFORD_3D_IN_PATH,
                                              STANFORD_3D_OUT_PATH)
