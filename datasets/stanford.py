...
class StanfordDataset(StanfordVoxelizationDatasetBase, VoxelizationDataset):
    ...
    TRANSLATION_AUGMENTATION_RATIO_BOUND = ((-0.2, 0.2), (-0.2, 0.2), (-0.05,
                                                                       0.05))
    ...
    def __init__(self,
        ...
        if isinstance(self.DATA_PATH_FILE[phase], (list, tuple)):
            ...
            data_paths = read_txt(
                os.path.join('splits/stanford', self.DATA_PATH_FILE[phase]))
...
class StanfordArea5Dataset(StanfordDataset):
    ...
    DATA_PATH_FILE = {
        DatasetPhase.Train:
        ['area1.txt', 'area2.txt', 'area3.txt', 'area4.txt', 'area6.txt'],
        DatasetPhase.Val:
        'area5.txt',
        DatasetPhase.Test:
        'area5.txt'
